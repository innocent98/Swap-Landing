...
const CTASection = () => {
  return (
    <section className="relative bg-white py-10 px-0">
      <div className="container mx-auto max-w-full">
        <div className="bg-gradient-to-br from-[#f0f4f8] to-[#e8f0f7] rounded-[48px] p-6 md:p-16 lg:p-20 overflow-hidden">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div>
              <h2 className="font-sora text-2xl md:text-4xl lg:text-5xl font-bold text-[#1a1d3a] mb-6 leading-tight">
                Sign Up for Early Access & Best Rates.
              </h2>
              <p className="font-sora text-sm md:text-lg text-[#4a4a68] mb-8 leading-relaxed">
