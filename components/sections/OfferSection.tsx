    ...
    <section id="features" className="relative bg-[#1a1d3a] py-10 px-0 overflow-hidden">
      <div className="container mx-auto max-w-full">
        ...
        <div className="mb-16">
          ...
          <h2 className="font-sora text-2xl md:text-4xl font-bold text-white mb-6">
            What We Offer
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-gradient-to-br from-[#f8f7ff] to-[#f0eeff] rounded-[32px] p-5 relative">
            ...
            <div className="pt-20">
              <h3 className="font-sora text-2xl md:text-4xl font-bold text-[#0f0f2e] mb-4">
                Get Best Deals
              </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-gradient-to-br from-[#f8f7ff] to-[#f0eeff] rounded-[32px] p-5 relative">
            ...
            <div className="pt-20">
              <h3 className="font-sora text-2xl md:text-3xl font-bold text-[#0f0f2e] mb-4">
                Get Escrow Security
              </h3>
              <p className="font-sora text-sm md:text-base text-[#4a4a68] leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-[#e8f4ff] to-[#f0f7ff] rounded-[32px]  relative overflow-hidden">
          <div className="grid md:grid-cols-2 gap-12 items-center relative z-10">
            {/* Left Content */}
            <div className='p-5 md:pr-0 md:p-16'>
              {/* Bank Icon */}
              ...
              <h3 className="font-sora text-2xl md:text-4xl font-bold text-[#0f0f2e] mb-6 leading-tight">
                Trade with Confidence, Data-Driven
              </h3>
              <p className="font-sora text-sm md:text-lg text-[#4a4a68] leading-relaxed mb-8">
